...
async def join(client, invite_link):
    try:
        ...
        return "تم الانضمام الي القناه بنجاح"
    except UserAlreadyParticipant:
        return "User is already a participant."
    except (InviteHashInvalid, InviteHashExpired):
        return "لا يمكن الانضمام. ربما الرابط الخاص بك منتهي الصلاحية أو غير صالح."
    except FloodWait:
        return "في طلبات كتير حاول وقت تاني."
    except Exception as e:
        print(e)
        return f"{e} \nتعذر الانضمام حاول يدوي."
